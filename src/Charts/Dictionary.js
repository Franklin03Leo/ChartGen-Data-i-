 ...
 const handleChangeDatatype = (event, flag, dim) => {  
  ...
  cols.forEach((event, index) => {
    ...
    //   value.graphicon = 'Category'}     
      ...
      if (value.min == 'Number') { value.graphicon = 'histogram' }
    }
                 ...
                 >
                   ...
                   <TableCell >
                     {row.graphicon =='histogram' ? (
                       <img src={histogram} alt="Logo" onClick={handleClick_histo}></img>

            ) : (
              <img src={categorical} alt="Logo" onClick={handleClick_cat}></img>
            )}</TableCell>
